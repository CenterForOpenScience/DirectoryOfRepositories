...
class Repository(models.Model):
    ...
    contact = models.CharField(max_length=500, blank=True, default='')
    metadataInformationURL = models.URLField(verbose_name="Metadata Information URL", blank=True)
    metadataRemarks = models.CharField(max_length=1000, blank=True, default='', verbose_name="Metadata Remarks")
    size = models.CharField(max_length=500, blank=True, default='')
    date_operational = models.DateField(default=datetime.date.today())
    created = models.DateTimeField(auto_now_add=True)
    title = models.CharField(max_length=100, blank=True, default='')
    remarks = models.CharField(max_length=10000, blank=True, default='')
    embargoed = models.BooleanField(default=True, verbose_name='Hidden on site')
