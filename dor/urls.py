...
urlpatterns = (
    ...
    url(r'^forgot_password_form/$', 'dor.views.forgot_password_form'),
    url(r'^forgot_password_request/$', 'dor.views.forgot_password_request'),
    url(r'^reset_password/(?P<verification_key>[-\w]+)/$', 'dor.views.reset_password_form'),
    url(r'^reset_password_submit/$', 'dor.views.reset_password_submit'),
